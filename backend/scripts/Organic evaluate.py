...
print(f"{'='*70}")
print(f"  MODEL: Ridge Regression — Organic Rice")
print(f"{'='*70}")
...
# ── Save Model + Scaler ────────────────────────────────────────────────────────
joblib.dump(model,  r"C:\Users\scvst\Desktop\Pune Hackathon\model_organic.pkl")
joblib.dump(scaler, r"C:\Users\scvst\Desktop\Pune Hackathon\scaler_organic.pkl")

print("✅ Model saved  → model_organic.pkl")
print("✅ Scaler saved → scaler_organic.pkl")